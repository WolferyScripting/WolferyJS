...
export const ControlledCharactersDefinition: Record<string, PropertyDefinition> = {};

export const ExitsDefinition: Record<string, PropertyDefinition> = {};

export const GlobalTeleportsDefinition: Record<string, PropertyDefinition> = {};
...
export const OwnedRoomsDefinition: Record<string, PropertyDefinition> = {};

export const ProfilesDefinition: Record<string, PropertyDefinition> = {};
