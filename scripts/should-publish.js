...
const d = Date.now();
const date = new Date(execSync("npm view wolfery.js time.modified --json").toString().slice(1,-2));
const latestDev = execSync("npm view wolfery.js dist-tags.dev --json").toString().slice(1,-2).split(".").slice(-1)[0];
